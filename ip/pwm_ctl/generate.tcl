...
set bus_name pwm_ctl
set abs_name pwm_ctl_rtl
...
pip_add_bus_abstraction_port [ipx::current_busabs] DEF_VAL {
	default_value 0
	master_direction in
	master_width 1
	slave_width 1
...
pip_add_bus_abstraction_port [ipx::current_busabs] NUMERATOR {
	default_value 0
	master_direction out
...
pip_add_bus_abstraction_port [ipx::current_busabs] DENOMINATOR {
	default_value 0
	master_direction out
	master_presence required
	slave_presence required
